...
characters =  alphabet[:]
modelPath = "./ocr/my_model_keras.h5"#os.path.join(os.getcwd(), "ocr/my_model_keras.h5")
#modelPath = '/Users/xiaofeng/Code/Github/dataset/CHINESE_OCR/save_model/my_model_keras.h5'
output_model = './ocr/my_model_onnx.h5.onnx'
height = 32
...
if os.path.exists(modelPath):
	...
	#onnx.save_model(onnx_model, output_model)

 
input_model = modelPath #args.keras_model
...
# 将keras模型转换为onnx模型
onnx_net = onnxmltools.convert_keras(basemodel)
# 将onnx模型文件保存下来
